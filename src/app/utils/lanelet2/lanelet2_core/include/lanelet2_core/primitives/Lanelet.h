...
class LaneletData : public PrimitiveData {
 public:
  ...
  ConstLineString3d calculatedCenterline() const;
 ...
 private:
  ...
  mutable std::shared_ptr<ConstLineString3d> calculated_centerline_;
};
...
class ConstLanelet : public ConstPrimitive<LaneletData> {
 public:
  ...
  ConstLineString3d calculatedCenterline() const { return calculatedCenterline3d(); }
  ...
  ConstLineString2d calculatedCenterline2d() const { return utils::to2D(calculatedCenterline3d()); }
  ...
  ConstLineString3d calculatedCenterline3d() const {
    return inverted() ? constData()->calculatedCenterline().invert() : constData()->calculatedCenterline();
  }
  //! Returns whether the centerline has been overridden by setCenterline
